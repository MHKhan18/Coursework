...
/*
 * Apparently @FlowScoped does not work with @Named!
 */
// @Named
@Named("addUserBacking")
// @ClientWindowScoped
@FlowScoped(value="add-user")
public class AddUser extends BaseBacking {
	...
	@Inject
	private IMessageService userService;
	...
	public String addUser() {
		...
		try {
			 ...
			 */
			return Navigation.ADD_USER_QRCODE;
	 ...
	 *
	 * This backing bean must still be in scope when we navigate to the page
	 * that shows the QR code, hence it must be flow-scoped instead of request-scoped.
	 */
